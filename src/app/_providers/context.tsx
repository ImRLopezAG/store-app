...
const getBase = (attribute: TemplateStringsArray) => `/product_feed/rollup_threads/v2?filter=marketplace(US)&filter=language(en)&filter=attributeIds(${attribute[0]})&anchor=10&consumerChannelId=d9a5bc42-4b9c-4976-858a-f159cf99c647&count=16&language=en&localizedRangeStr={lowestPrice} — {highestPrice}`;
